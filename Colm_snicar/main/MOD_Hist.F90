...
!************************************************************
         ...
         call write_history_variable_2d ( DEF_hist_vars%up_dir_per, &
         a_up_dir_per, file_hist, 'f_up_dir_per', itime_in_file, sumarea, filter, &
         'direct up energy from the surface layer','%')

         call write_history_variable_2d ( DEF_hist_vars%up_dif_per, &
         a_up_dif_per, file_hist, 'f_up_dif_per', itime_in_file, sumarea, filter, &
         'diffuse up energy from the surface layer','%')

         call write_history_variable_2d ( DEF_hist_vars%phi_srf_dif, &
         a_phi_srf_dif, file_hist, 'f_phi_srf_dif', itime_in_file, sumarea, filter, &
         'surface absorb energy diffuse','W/m2')

         call write_history_variable_2d ( DEF_hist_vars%phi_srf_dir, &
         a_phi_srf_dir, file_hist, 'f_phi_srf_dir', itime_in_file, sumarea, filter, &
         'surface absorb energy direct','W/m2')

         call write_history_variable_3d ( DEF_hist_vars%phi_dir_per, &
            a_phi_dir_per, file_hist, 'f_phi_dir_per', itime_in_file, 'snowlake', maxsnl+1, nl_lake-maxsnl, sumarea, filter, &
            'direct in phi','%')

         call write_history_variable_3d ( DEF_hist_vars%phi_dif_per, &
            a_phi_dif_per, file_hist, 'f_phi_dif_per', itime_in_file, 'snowlake', maxsnl+1, nl_lake-maxsnl, sumarea, filter, &
            'diffuse in phi','%')
         ! lake temperature [K]
