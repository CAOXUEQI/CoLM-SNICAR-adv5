...
SUBROUTINE CoLMMAIN ( &
         ...
         ! land surface variables required for restart
           ...
           phi_dir_per,phi_dif_per,up_dir_per,up_dif_per,phi_srf_dif,phi_srf_dir,&          
...
! ----------------------------------------------------------------------
  ...
  real(r8), intent(inout) :: &
        ...
        phi_dir_per(maxsnl+1:nl_lake),&
        phi_dif_per(maxsnl+1:nl_lake),&
        up_dir_per,&
        up_dif_per,&
        phi_srf_dif,&
        phi_srf_dir,&
...
!======================================================================
      ...
      CALL newsnow_lake ( &
           ...
           fiold(:0)    ,snl          ,sag             ,scv             ,&
           snowdp       ,lake_icefrac )
      write(*,*)'soil_s_v_alb',soil_s_v_alb,soil_d_v_alb,soil_s_n_alb,soil_d_n_alb
      CALL laketem ( &
...
! END SNICAR model variables
          ...
          phi_dir_per,phi_dif_per,up_dir_per,up_dif_per,phi_srf_dif,phi_srf_dir            )
      ! write(*,*)"laketemp end"
      ! write(*,*)'shape of phi_dir_per',shape(phi_dir_per)
      CALL snowwater_lake ( &
