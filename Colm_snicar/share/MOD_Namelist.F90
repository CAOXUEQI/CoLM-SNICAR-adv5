...
MODULE MOD_Namelist
   ...
   TYPE history_var_type
      ...
      LOGICAL :: phi_dir_per        = .true.
      LOGICAL :: phi_dif_per        = .true.
      LOGICAL :: up_dir_per        = .true.
      LOGICAL :: up_dif_per        = .true.
      LOGICAL :: phi_srf_dif        = .true.
      LOGICAL :: phi_srf_dir        = .true.
      LOGICAL :: xy_us        = .true.
      LOGICAL :: xy_vs        = .true.
      LOGICAL :: xy_t         = .true.
      LOGICAL :: xy_q         = .true.
...
! ----- SNICAR model ------ Macros&Namelist conflicts and dependency management
         ...
         DEF_file_lakeicepro = '/stu01/caoxq18/SNICAR-ADv5/new_sparkling/sparkling_bc_processed_data_den.nc'
...
! ===============================================================
   ...
   SUBROUTINE sync_hist_vars (set_defaults)
      ...
      CALL sync_hist_vars_one (DEF_hist_vars%phi_dir_per       ,  set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%phi_dif_per       ,  set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%up_dir_per       ,  set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%up_dif_per       ,  set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%phi_srf_dif       ,  set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%phi_srf_dir       ,  set_defaults)
